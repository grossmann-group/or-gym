...
class NetInvMgmtMasterEnv(gym.Env):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Retailer
        self.graph.add_nodes_from([1], I0 = 60,
                                        h = 0.030)
        # Distributors
        self.graph.add_nodes_from([2], I0 = 70,
                                        h = 0.020)
        self.graph.add_nodes_from([3], I0 = 65,
                                        h = 0.015)
        # Manufacturers
        self.graph.add_nodes_from([4], I0 = 75,
                                        C = 30,
                                        o = 0.010,
                                        v = 1.000,
                                        h = 0.012)
        self.graph.add_nodes_from([5], I0 = 80,
                                        ...
                                        v = 1.000,
                                        h = 0.013)
        self.graph.add_nodes_from([6], I0 = 85,
                                        C = 40,
                                        o = 0.012,
                                        v = 1.000,
                                        h = 0.011)
